package net.felix.ratsmod.networking;

import net.felix.ratsmod.RatsMod;
import net.felix.ratsmod.networking.packet.DrinkWaterC2SPacket;
import net.felix.ratsmod.networking.packet.ExampleC2SPacket;
...
public class ModMessages {
    ...
    public static void register() {
        SimpleChannel net = NetworkRegistry.ChannelBuilder
                .named(new ResourceLocation(RatsMod.MOD_ID, "messages"))
